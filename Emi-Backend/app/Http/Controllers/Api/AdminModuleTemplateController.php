...
{
    public function __construct(private readonly ModuleTemplateService $service) {}
    ...
    public function publish(Request $request, string $id): JsonResponse
    {
        ...
        return ApiResponse::success('Template modul berhasil dipublish.', new ModuleTemplateResource($this->service->publish($template, $request->user(), $request)));
    }
