...
use App\Policies\QuizTemplateQuestionPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(QuizTemplateQuestion::class, QuizTemplateQuestionPolicy::class);
        Gate::policy(ClassQuiz::class, ClassQuizPolicy::class);
