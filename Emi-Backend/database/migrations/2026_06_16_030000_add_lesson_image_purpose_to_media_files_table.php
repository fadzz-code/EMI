...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE media_files ADD CONSTRAINT media_files_purpose_check CHECK (purpose IN ('avatar', 'question_image', 'lesson_image', 'document', 'audio', 'speaking_recording'))");
    }
