    ...
    private function quizzes(): array
    {
        return [
            ...
            ['title' => 'Demo: Kuis Bahasa dan Budaya Mekongga', 'description' => 'Kuis demo untuk modul bahasa dan budaya.', 'questions' => [
                ['question' => 'EMI membantu siswa belajar bahasa Mekongga melalui ...', 'options' => ['Modul, kamus, kuis, speaking', 'Hanya membaca daftar nilai', 'Hanya absensi', 'Hanya upload foto'], 'answer' => 'Modul, kamus, kuis, speaking', 'explanation' => 'Alur EMI mencakup beberapa fitur belajar.'],
