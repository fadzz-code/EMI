...
export function StudentModuleList() {
  ...
  return (
    <div className="grid gap-6">
      <PageHeader
        badge="Siswa"
        description="Modul published dari kelas aktif siswa. Progress berasal dari backend."
        title="Modul Saya"
      />
        ...
        modules.length === 0 ? (
          ...
          <div className="grid gap-4">
            <section className="grid gap-4 sm:grid-cols-3">
              <StatsCard helper="Endpoint /student/modules" label="Total Modul" value={formatCount(modules.length)} />
