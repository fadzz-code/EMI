...
export const teacherRoutes = {
  ...
  dictionary: "/teacher/dictionary",
  dictionaryDetail: (entryId: string) => `/teacher/dictionary/${entryId}`,
  speakingExercises: "/teacher/speaking/exercises",
  speakingExercisePreview: (exerciseId: string) => `/teacher/speaking/exercises/${exerciseId}/preview`,
  ...
  quizPreview: (classQuizId: string) => `/teacher/quizzes/${classQuizId}/preview`,
  moduleEdit: (moduleId: string) => `/teacher/modules/${moduleId}/edit`,
  modulePreview: (moduleId: string) => `/teacher/modules/${moduleId}/preview`,
  lessonEdit: (moduleId: string, lessonId: string) => `/teacher/modules/${moduleId}/lessons/${lessonId}/edit`,
  lessonPreview: (moduleId: string, lessonId: string) => `/teacher/modules/${moduleId}/lessons/${lessonId}/preview`,
...
export const roleNavItems: Record<UserRole, NavItem[]> = {
  ...
  teacher: [
    ...
    { label: "Kamus", href: teacherRoutes.dictionary, status: "ready", icon: LibraryBig },
    { label: "Budaya Mekongga", href: teacherRoutes.culture, status: "ready", icon: Globe },
    { label: "Chatbot AI", href: teacherRoutes.chatbot, shortLabel: "Chatbot", status: "ready", icon: MessageSquare },
